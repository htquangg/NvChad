...
local default_plugins = {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>tt", "<cmd>w|lua require('neotest').run.run(vim.fn.expand('%'))<cr>", desc = "File" },
      { "<leader>tT", "<cmd>w|lua require('neotest').run.run(vim.uv.cwd())<cr>", desc = "All File" },
      ...
      {
        "<leader>tO",
        "<cmd>w|lua require('neotest').output_panel.toggle()<cr>",
